...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:64px;margin-right:10px;color:orange">good sale flipkart shopping</span>
            <ul id="menu">
         ...
         <h1> NO Mobile offers will be available till 30th September 2023</h1>   
